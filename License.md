![License: Engross](https://img.shields.io/badge/License-Engross-blue.svg)
![Attribution Required](https://img.shields.io/badge/Attribution-Required-orange.svg)
![Commercial Use](https://img.shields.io/badge/Commercial%20Use-Allowed%20With%20Compensation-yellow.svg)
![Educational Use](https://img.shields.io/badge/Educational%20Use-Allowed%20%2F%20No%20Fee-green.svg)
![Modifications Documented](https://img.shields.io/badge/Modifications-Must%20Be%20Documented-red.svg)

The Engross License (EGL) v1.0
Copyright © [2026] [Joey Soprano]

Permission is hereby granted to any individual or organization (“User”) to use, copy, modify, merge, publish, distribute, and/or sample this work (“the Work”), subject to the following conditions:

1. Attribution & Citation (Required for All Uses)
Users must provide clear, accessible, and prominent citation to the original author(s) in all public, private, distributed, or derivative uses of the Work.
...
A statement indicating whether the Work was modified

Failure to provide proper citation constitutes misrepresentation and results in immediate revocation of all rights granted under this license.

2. Commercial Use
Commercial use is permitted only if:

The original author(s) receive mutually agreed-upon compensation, and

The original author(s) are explicitly credited in all commercial materials, documentation, and derivative works.

Commercial use without compensation or proper credit is strictly prohibited and constitutes grounds for license revocation.

3. Educational & Non‑Profit Use
Educational institutions, researchers, and non‑profit organizations may use the Work without monetary compensation, provided that:

The use is non‑commercial in intent,

The purpose of use is clearly stated,

Attribution requirements (Section 1) are fully met, and

The statement of intent is publicly accessible (e.g., syllabus, documentation, project page).

4. Modification & Derivative Works
Users may modify the Work, create derivative works, or integrate it into larger systems, provided that:

All modifications are clearly documented, including:
...
A notice stating “Modified from the original Work by [User]” is included

The original Work remains clearly distinguishable from the modifications

5. Sampling & Demonstrational Use
Sampling portions of the Work for demonstrations, presentations, or examples is permitted under the following conditions:

Proper citation is provided (Section 1)

No more than 50% of the Work may be displayed, reproduced, or included in any demonstrational context

The sampling does not imply endorsement by the original author(s)

6. Collaborative Projects & Joint Ventures
Any collaborative use of the Work—whether through joint ventures, multi‑author projects, or organizational integration—must:

Register all officially involved contributors or entities

Maintain clear attribution to the original author(s)

Ensure all third parties comply with this license

7. Third‑Party Use
Any third party using the Work, directly or indirectly, must:

Register as a third‑party user (e.g., via project documentation or contributor list)

Provide proper citation

Adhere to all terms of this license
...
Commercial compensation requirements

Misrepresentation of intent

Fraudulent use

Failure to document modifications

…results in immediate and automatic revocation of all rights granted under this license.

Upon revocation, the User must cease all use, distribution, and derivative development of the Work.
...
IN NO EVENT SHALL THE AUTHOR(S) BE LIABLE FOR ANY CLAIM, DAMAGES, OR OTHER LIABILITY ARISING FROM THE USE OF THE WORK.

10. Acceptance of Terms
Use of the Work in any capacity constitutes acceptance of all terms in this license.

## ---------- ##

SOVEREIGN UNIVERSAL ENTITY TECHNICAL LICENSE (S.U.E.T.) — v1.0
Effective Date: [07/05/2026]
Copyright (c) [2026] [Joey Soprano and ChatGPT]
